...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var deptsInChicago = depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo);

        List<Emp> result = emps.Where(e => deptsInChicago.Contains(e.DeptNo)).ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        //I don't really know how to use selectMany here:/
